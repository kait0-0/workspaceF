...
class Affine_translation:
    ...
    def affine_translation(self):
        ...
        for i, simplex in enumerate(self.tri.simplices):
            pt1 = (int(self.contours[simplex[0]][0]), int(self.contours[simplex[0]][1]))
            pt2 = (int(self.contours[simplex[1]][0]), int(self.contours[simplex[1]][1]))
            pt3 = (int(self.contours[simplex[2]][0]), int(self.contours[simplex[2]][1]))
